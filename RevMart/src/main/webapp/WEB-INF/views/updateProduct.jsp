                            ...
                            <form action="${pageContext.request.contextPath}/admin/updateProduct" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" ${product.isActive ? 'checked' : ''} value="true" name="isActive" id="flexRadioDefault1">
                                        <label class="form-check-label" for="flexRadioDefault1">Active</label>
                                    </div>

                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" ${!product.isActive ? 'checked' : ''} value="false" name="isActive" id="flexRadioDefault2">
