	...
	public String searchProduct(@RequestParam String ch, Model m) {
	 ...
	 @GetMapping("/userHome")
	    public String userHome() {
	        return "userHome"; // This should match the name of your JSP file without the extension
	    }
	 @GetMapping("/userIndex")
	    public String userIndex() {
	        return "userIndex"; // This should match the name of your JSP file without the extension
	    }
	 @RequestMapping("/aboutus1")
	    public String aboutUs() {
	        return "aboutus1"; // View name, so aboutus1.jsp or aboutus1.html should exist in templates or static folder
	    }
}
